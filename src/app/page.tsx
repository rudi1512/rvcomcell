  ...
  return (
    <div className="flex-grow bg-slate-50 text-slate-800 relative overflow-hidden font-sans">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 md:py-16 relative z-10 flex flex-col space-y-20 md:space-y-28">
        ...
        ========================================== */}
        <section className="relative overflow-hidden rounded-[2.5rem] bg-slate-900 border border-slate-800 p-8 md:p-16 shadow-2xl flex flex-col items-center justify-center text-center group">
          
          {/* Animated Background Gradients */}
          <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 via-indigo-500/10 to-purple-500/10 opacity-50 group-hover:opacity-100 transition-opacity duration-700" />
          <div className="absolute top-0 right-0 w-96 h-96 bg-blue-500/20 rounded-full blur-3xl transform translate-x-1/3 -translate-y-1/2" />
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-purple-500/20 rounded-full blur-3xl transform -translate-x-1/3 translate-y-1/2" />
          <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 mix-blend-overlay"></div>

          <div className="relative z-10 max-w-3xl flex flex-col items-center">
            <span className="bg-white/10 text-white border border-white/20 text-[10px] font-black px-4 py-2 rounded-full tracking-wider uppercase inline-block mb-6 backdrop-blur-md">
              Mari Berkolaborasi
            </span>
            ...
            <p className="text-slate-300 text-sm md:text-base mb-10 leading-relaxed max-w-2xl font-medium">
              Konsultasikan jenis laptop yang ingin dibeli, kebutuhan perbaikan hardware, pembuatan aplikasi custom bisnis, atau tanyakan ketersediaan slot kelas kursus sekarang juga. Kami siap membantu menemukan solusi terbaik untuk Anda.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <a 
                href={whatsappLink}
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-400 hover:to-emerald-500 text-white font-bold py-4 px-8 rounded-2xl shadow-lg shadow-emerald-500/25 hover:shadow-emerald-500/40 transition-all inline-flex items-center justify-center space-x-3 transform hover:-translate-y-1"
              >
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
